<template>
   <button @click="handleClick" class="flex relative overflow-hidden flexCentered p-4 bg-navy-light w-28 rounded-[4px] hover:bg-navy-light/70 focus-visible:bg-navy-light/70" ref="me">
      <slot />
   </button>
</template>
